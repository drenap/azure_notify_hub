...
public class NotificationService extends FirebaseMessagingService {
    public static final String NOTIFICATION_CHANNEL_ID = "azure_notify_hub";
    ...
    public static final String ACTION_REMOTE_MESSAGE = "com.multicode.azure_notify_hub.NOTIFICATION";
    public static final String ACTION_TOKEN = "com.multicode.azure_notify_hub.TOKEN";
    public static final String EXTRA_REMOTE_MESSAGE = "com.multicode.azure_notify_hub.NOTIFICATION_DATA";
    public static final String EXTRA_TOKEN = "com.multicode.azure_notify_hub.TOKEN_DATA";
